  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link texto-blanco" href="{{ route('servicios') }}">SafetyDogs Premium</a>
        </li>
        <li class="nav-item">
          <a class="nav-link texto-blanco" href="{{ route('servicios') }}">Contacto</a>
        </li>
        <li class="nav-item">
          <a class="nav-link texto-blanco" href="{{ route('servicios') }}">Soporte</a>
        </li>
